        ...
        for (int i = a; i < b; i++) {
            if (!reportsList.isEmpty()) {
                if (!reportsList.get(i).isIsClosed()) {
                    ...
                    loader.setLocation(getClass().getResource("/blastandburn/views/ui/frontoffice/report/OpenReportItem.fxml"));
                    try {
                        pane = loader.load();
                    ...
                    FXMLLoader loader = new FXMLLoader();
                    loader.setLocation(getClass().getResource("/blastandburn/views/ui/frontoffice/report/ClosedReportItem.fxml"));
                    try {
                        pane = loader.load();
                    } catch (IOException ex) {
                        Logger.getLogger(ReportGridController.class.getName()).log(Level.SEVERE, null, ex);
