...
public class LoginController implements Initializable {
    ...
    private void signInAction(ActionEvent event) throws IOException {
        ...
        if (emailSI) {
            ...
            if (!flag) {
                ...
                String path = "/blastandburn/views/ui/frontoffice/HomePageHolder.fxml";
                this.showAlert(UserSession.getRole());
                if (UserSession.getRole().equals("ROLE_Moderator")) {
                    path =  "/blastandburn/views/ui/backoffice/AdminPageHolder.fxml";
                }
    ...
    private void signUpAction(ActionEvent event) {
        ...
        String Msg = "Bonjour Mr/Mme , Bienvenu a notre application Blast And Burn Dear  " + TFFirstNameSUP.getText() + " " + TFLastNameSUP.getText()
                + "                                                                                                   "
                + "     by signing up , you've taken your first step toward a healthier life . we'll do everything we can to help you and support you "
                + "yours                                                           ";
