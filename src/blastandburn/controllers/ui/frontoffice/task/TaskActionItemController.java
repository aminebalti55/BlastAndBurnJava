...
public class TaskActionItemController implements Initializable {
    ...
    public void setData(SessionActions ta){
    ...
    private void updateTaskAction(MouseEvent event) throws IOException {
        ...
        tah.setId(id);
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/blastandburn/views/ui/frontoffice/task/UpdateTaskActionF.fxml"));
