...
public class UpdateTaskActionFController implements Initializable {
    ...
    SessionActions ta;
    ServiceSessionActions sta = new ServiceSessionActions();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ta = sta.searchSessionActions(tah.getId());
    ...
    private void updateTaskAction(MouseEvent event) {
        ...
        SessionActions t = new SessionActions();
        t.setTitle(Titre.getText());
        t.setDescription(Description.getText());
        sta.updateSessionActions(tah.getId(), t);
