 ...
 */
package blastandburn.controllers.ui.backoffice.event;
...
ObservableList<Event> l;
    ...
    private void CategoryAction(ActionEvent event) throws IOException {
         FXMLLoader loader = new FXMLLoader(getClass().getResource("/blastandburn/views/ui/backoffice/event/EventCategory.fxml"));
